...
router.get('/leads/pipeline', authenticate, leads.leadPipeline);
...
router.post('/leads/:id/visit-reports', authenticate, validate(v.visitReportSchema), leads.addVisitReport);
router.put('/leads/:id/visit-reports/:visitId', authenticate, validate(v.updateVisitReportSchema), leads.updateVisitReport);
router.delete('/leads/:id/visit-reports/:visitId', authenticate, leads.deleteVisitReport);
