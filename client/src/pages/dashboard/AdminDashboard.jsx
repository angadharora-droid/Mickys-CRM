...
import { Contact, Sparkles, Package, Send, Users, UserCheck, Trophy, Medal } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Admin Dashboard" description="Leads, kits and the score card across the team" />
